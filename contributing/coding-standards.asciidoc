...
- `DIAG_ON_OPTIONAL(<diagnostic>)` sets the specified diagnostic to produce a warning, but will not produce a warning itself if the diagnostic is unknown by the compiler.
